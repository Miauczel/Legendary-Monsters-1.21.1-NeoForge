...
public class ITamableMobMoveGoal extends Goal {
    private final IAnimatedTamableMob monster;
    private final boolean followingTargetEvenIfNotSeen;
    private Path path;
    private int delayCounter;
    protected final double moveSpeed;

    public ITamableMobMoveGoal(IAnimatedTamableMob boss, boolean followingTargetEvenIfNotSeen, double moveSpeed) {
        this.monster = boss;
