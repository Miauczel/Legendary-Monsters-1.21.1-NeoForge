...
public class PossessedPaladinWingsLayer extends RenderLayer<PossessedPaladinEntity, NewPossessedPaladinModel<PossessedPaladinEntity>> {
    private static final ResourceLocation POSSESSED_PALADIN_WINGS = ResourceLocation.fromNamespaceAndPath(LegendaryMonsters.MOD_ID, "textures/entity/posessed_paladin/layer/possessed_paladin_wings_layer.png");
    private static final ResourceLocation POSSESSED_PALADIN_WINGS_RED = ResourceLocation.fromNamespaceAndPath(LegendaryMonsters.MOD_ID, "textures/entity/posessed_paladin/layer/possessed_paladin_wings_red_layer.png");
