...
public class FracturedApostleKnifeLayer extends RenderLayer<FracturedApostleEntity, FracturedApostleModel<FracturedApostleEntity>> {
    private static final ResourceLocation BODY = ResourceLocation.fromNamespaceAndPath(LegendaryMonsters.MOD_ID, "textures/entity/fractured_apostle/fractured_apostle_knife.png");
