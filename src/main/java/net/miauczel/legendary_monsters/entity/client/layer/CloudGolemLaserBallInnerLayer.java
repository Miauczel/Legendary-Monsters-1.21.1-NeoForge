...
public class CloudGolemLaserBallInnerLayer extends RenderLayer<Cloud_GolemEntity, Cloud_GolemModel<Cloud_GolemEntity>> {
    private static final ResourceLocation LOCATION = ResourceLocation.fromNamespaceAndPath(LegendaryMonsters.MOD_ID,"textures/entity/cloud_golem/laser_ball/laser_ball_inner.png");
    ...
    this.getParentModel().renderToBuffer(matrixStackIn, VertexConsumer, FastColor.ARGB32.colorFromFloat(0.6f, 0.76f, 0.76f, 0.76f), OverlayTexture.NO_OVERLAY);
}else {
