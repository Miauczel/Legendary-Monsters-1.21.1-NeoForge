...
public class SecondPhaseStateGoal extends Goal {
    ...
    public SecondPhaseStateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick) {
        this.entity = entity;
    ...
    public SecondPhaseStateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, boolean interruptsAI) {
        this.entity = entity;
        if (interruptsAI) {
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    public boolean canUse() {
        return this.entity.getAttackState() == this.getattackstate && entity.getPhase() <= 1 && (entity.getCrackiness() == TheObliteratorEntity.Crackiness.MEDIUM || entity.getCrackiness() == TheObliteratorEntity.Crackiness.HIGH);
    }
