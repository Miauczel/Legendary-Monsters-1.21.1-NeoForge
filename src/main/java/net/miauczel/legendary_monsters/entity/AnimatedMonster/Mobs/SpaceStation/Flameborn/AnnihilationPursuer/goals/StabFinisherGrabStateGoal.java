...
public class StabFinisherGrabStateGoal extends Goal {
    ...
    public StabFinisherGrabStateGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick) {
        this.entity = entity;
    ...
    public StabFinisherGrabStateGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, boolean interruptsAI) {
        this.entity = entity;
        if (interruptsAI) {
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    public void stop() {
        ...
        this.entity.setAttackState(entity.succedGrabbing ? 15 : 16);
