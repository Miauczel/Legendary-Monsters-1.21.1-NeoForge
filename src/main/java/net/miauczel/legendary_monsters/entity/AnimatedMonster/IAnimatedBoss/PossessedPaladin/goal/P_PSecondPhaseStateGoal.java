...
public class P_PSecondPhaseStateGoal extends Goal {
    ...
    public P_PSecondPhaseStateGoal(PossessedPaladinEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick) {
        this.entity = entity;
    ...
    public P_PSecondPhaseStateGoal(PossessedPaladinEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, boolean interruptsAI) {
        this.entity = entity;
        if (interruptsAI) {
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    public boolean canUse() {
        return this.entity.getAttackState() == this.getattackstate && entity.getPhase() <= 1 && (entity.getCrackiness() == PossessedPaladinEntity.Crackiness.MEDIUM || entity.getCrackiness() == PossessedPaladinEntity.Crackiness.HIGH);
    }
