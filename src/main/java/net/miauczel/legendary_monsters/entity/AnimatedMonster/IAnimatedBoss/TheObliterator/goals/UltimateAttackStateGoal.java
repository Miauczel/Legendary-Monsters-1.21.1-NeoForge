...
public class UltimateAttackStateGoal extends Goal {
    ...
    public UltimateAttackStateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick) {
        this.entity = entity;
    ...
    public UltimateAttackStateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, boolean interruptsAI) {
        this.entity = entity;
        if (interruptsAI) {
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    public void tick() {
        ...
        if ((this.entity.attackTicks < 80 || (entity.attackTicks > 110 && entity.attackTicks < 130))&& target != null) {
