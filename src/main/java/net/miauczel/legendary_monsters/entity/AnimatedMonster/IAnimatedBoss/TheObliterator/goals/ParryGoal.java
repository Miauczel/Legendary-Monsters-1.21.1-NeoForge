...
public class ParryGoal extends Goal {
    ...
    public ParryGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, float attackrangemin) {
        this.entity = entity;
    ...
    public ParryGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange,  float attackrangemin,EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
    ...
    public void stop() {
    this.entity.setAttackState(entity.gambitParry ? 59 : 57);
