...
public class SwordTeleportSlamGoal extends Goal {
    ...
    public SwordTeleportSlamGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, float attackrangemin) {
        this.entity = entity;
    ...
    public SwordTeleportSlamGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange,  float attackrangemin,EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
