...
public class BackStepStompRightGoal extends Goal {
    ...
    public BackStepStompRightGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange) {
        this.entity = entity;
    ...
    public BackStepStompRightGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
    ...
    public void stop() {
        switch (entity.getRandom().nextInt(2)){
            case 0 ->entity.setAttackState(48);
           case 1 ->entity.setAttackState(48);
        }
