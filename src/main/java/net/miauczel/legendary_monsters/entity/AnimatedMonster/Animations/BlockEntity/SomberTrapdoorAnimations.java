...
public class SomberTrapdoorAnimations {
    public static final AnimationDefinition open = AnimationDefinition.Builder.withLength(1.6667F)
            .addAnimation("door_left", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.2083F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -95.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.6667F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -95.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
