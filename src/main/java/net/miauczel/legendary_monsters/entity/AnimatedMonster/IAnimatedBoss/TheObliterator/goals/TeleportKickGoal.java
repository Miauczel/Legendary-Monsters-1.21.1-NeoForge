...
public class TeleportKickGoal extends Goal {
    ...
    public TeleportKickGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, float attackrangemin) {
        this.entity = entity;
    ...
    public TeleportKickGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange,  float attackrangemin,EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
    ...
    public void tick() {
        LivingEntity target = this.entity.getTarget();
        if (target != null &&
                ((entity.attackTicks < 20) || (entity.attackTicks > 44 && entity.attackTicks < 50))) {
