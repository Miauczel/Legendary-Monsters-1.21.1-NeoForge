...
public class TeleportAwaySingleLaserShotGoal extends Goal {
    ...
    public TeleportAwaySingleLaserShotGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, float attackrangemin) {
        this.entity = entity;
    ...
    public TeleportAwaySingleLaserShotGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, float attackrangemin, EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
    ...
    public void stop() {
           ...
           // case 0 ->  this.entity.setAttackState(46);
    ...
    public void tick() {
        ...
        if ((this.entity.attackTicks < this.attackseetick || entity.isTargetCheesing(-4,4)) && target != null) {
            ...
            this.entity.lookAt(target, 30F, 180F);
        } else {
