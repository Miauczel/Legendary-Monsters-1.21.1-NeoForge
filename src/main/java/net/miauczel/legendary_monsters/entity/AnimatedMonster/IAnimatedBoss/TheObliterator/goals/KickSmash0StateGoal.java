...
public class KickSmash0StateGoal extends Goal {
    ...
    public KickSmash0StateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick) {
        this.entity = entity;
    ...
    public KickSmash0StateGoal(TheObliteratorEntity entity, int getattackstate, int attackstate, int attackendstate, int attackfinaltick, int attackseetick, boolean interruptsAI) {
        this.entity = entity;
        if (interruptsAI) {
            this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK, Flag.JUMP));
        }
    ...
    public void tick() {
        ...
        if (this.entity.attackTicks < this.attackseetick && entity.attackTicks >1 && target != null) {
