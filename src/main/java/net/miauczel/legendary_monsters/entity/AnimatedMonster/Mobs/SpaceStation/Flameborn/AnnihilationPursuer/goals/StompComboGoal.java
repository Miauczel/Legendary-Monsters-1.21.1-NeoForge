...
public class StompComboGoal extends Goal {
    ...
    public StompComboGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange) {
        this.entity = entity;
    ...
    public StompComboGoal(AnnihilationPursuerEntity entity, int getattackstate, int attackstate, int attackendstate, int attackMaxtick, int attackseetick, float attackrange, EnumSet<Flag> interruptFlagTypes) {
        this.entity = entity;
    ...
    public void stop() {
        this.entity.setAttackState(entity.getRandom().nextInt() * 100 <50 ? 3 : 4);
