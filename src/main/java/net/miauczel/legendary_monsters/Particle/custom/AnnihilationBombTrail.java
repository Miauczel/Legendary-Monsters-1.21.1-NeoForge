...
public class AnnihilationBombTrail extends AbstractTrailParticle {
    ...
    public AnnihilationBombTrail(
        ...
        this.initialYRot = random.nextFloat() * 360F;
        this.rotateByAge = (10 + random.nextFloat() * 10F) * (random.nextBoolean() ? -1F : 1F);
    ...
    public Vec3 getOrbitPosition() {
        ...
        Vec3 vec3 = new Vec3(0, height, width)
    ...
    public static final class OrbFactory implements ParticleProvider<OrbData> {
        ...
        public Particle createParticle(
            ...
            return new AnnihilationBombTrail(
                    worldIn,
                    x,
                    y,
                    z,
