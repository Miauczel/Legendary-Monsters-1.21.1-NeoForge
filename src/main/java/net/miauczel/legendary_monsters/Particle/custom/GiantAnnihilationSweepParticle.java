...
public class GiantAnnihilationSweepParticle extends TextureSheetParticle {
    ...
    public static class SweepData implements ParticleOptions {
        ...
        @Override
        public ParticleType<GiantAnnihilationSweepParticle.SweepData> getType() {
        ...
        public static class SweepType extends ParticleType<SweepData> {
            public SweepType(boolean overrideLimiter) {
